...
def register_robotics_envs():
    ...
    for reward_type in ["sparse", "dense"]:
        ...
        register(
            id=f"SwimmerMaze_UMaze{suffix}-v3",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.U_MAZE,
                },
        ...
        register(
            id=f"SwimmerMaze_UMaze{suffix}-v4",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze_v4:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.U_MAZE,
                },
        ...
        register(
            id=f"SwimmerMaze_Open{suffix}-v3",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.OPEN,
        ...
        register(
            id=f"SwimmerMaze_Open{suffix}-v4",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze_v4:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.OPEN,
        ...
        register(
            id=f"SwimmerMaze_Open_Diverse_G{suffix}-v3",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.OPEN_DIVERSE_G,
        ...
        register(
            id=f"SwimmerMaze_Open_Diverse_G{suffix}-v4",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze_v4:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.OPEN_DIVERSE_G,
        ...
        register(
            id=f"SwimmerMaze_Open_Diverse_GR{suffix}-v3",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.OPEN_DIVERSE_GR,
        ...
        register(
            id=f"SwimmerMaze_Open_Diverse_GR{suffix}-v4",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze_v4:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.OPEN_DIVERSE_GR,
        ...
        register(
            id=f"SwimmerMaze_Medium{suffix}-v3",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.MEDIUM_MAZE,
        ...
        register(
            id=f"SwimmerMaze_Medium{suffix}-v4",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze_v4:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.MEDIUM_MAZE,
        ...
        register(
            id=f"SwimmerMaze_Medium_Diverse_G{suffix}-v3",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.MEDIUM_MAZE_DIVERSE_G,
        ...
        register(
            id=f"SwimmerMaze_Medium_Diverse_G{suffix}-v4",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze_v4:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.MEDIUM_MAZE_DIVERSE_G,
        ...
        register(
            id=f"SwimmerMaze_Medium_Diverse_GR{suffix}-v3",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.MEDIUM_MAZE_DIVERSE_GR,
        ...
        register(
            id=f"SwimmerMaze_Medium_Diverse_GR{suffix}-v4",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze_v4:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.MEDIUM_MAZE_DIVERSE_GR,
        ...
        register(
            id=f"SwimmerMaze_Large{suffix}-v3",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.LARGE_MAZE,
        ...
        register(
            id=f"SwimmerMaze_Large{suffix}-v4",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze_v4:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.LARGE_MAZE,
        ...
        register(
            id=f"SwimmerMaze_Large_Diverse_G{suffix}-v3",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.LARGE_MAZE_DIVERSE_G,
        ...
        register(
            id=f"SwimmerMaze_Large_Diverse_G{suffix}-v4",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze_v4:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.LARGE_MAZE_DIVERSE_G,
        ...
        register(
            id=f"SwimmerMaze_Large_Diverse_GR{suffix}-v3",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.LARGE_MAZE_DIVERSE_GR,
        ...
        register(
            id=f"SwimmerMaze_Large_Diverse_GR{suffix}-v4",
            entry_point="gymnasium_robotics.envs.maze.swimmer_maze_v4:SwimmerMazeEnv",
            kwargs=_merge(
                {
                    "maze_map": maps.LARGE_MAZE_DIVERSE_GR,
